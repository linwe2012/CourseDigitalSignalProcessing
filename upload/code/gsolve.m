...
%
%% This Algorithm is modified by leon
 % The exposure B() will be an array instead of matrix
function [g,lE]=gsolve(Z,B,l,w)
    n = 256;
    A = zeros(size(Z,1)*size(Z,2)+n+1,n+size(Z,1), 'gpuArray');
    b = zeros(size(A,1),1, 'gpuArray');
